  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden bg-[#070b14]">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        {/* Blob 1 — Sky blue, top-right (mirrored from login) */}
        <div
        ...
        {/* Blob 2 — Indigo, bottom-left (mirrored from login) */}
        <div
      ...
      <div className="relative z-10 w-full max-w-4xl">
        <BorderAnimatedContainer>
          <div className="flex w-full rounded-2xl overflow-hidden backdrop-blur-[32px] bg-slate-950/50 border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
            {/* LEFT — Form */}
            <div className="w-full lg:w-1/2 p-8 md:p-10 flex flex-col gap-6">
              {/* Logo */}
              ...
              <div>
                ...
                <p className="text-slate-400 mt-2 text-sm font-medium leading-relaxed">
                  Start your global journey and turn conversations into real
                  friendships.
                </p>
              </div>
              ...
              <form onSubmit={handleSignup} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3.5 rounded-xl text-sm text-slate-100 placeholder-slate-600 outline-none transition-all focus:ring-2 ring-sky-500/20 focus:bg-white/5"
                      style={{
                ...
                <button
                  type="submit"
                  disabled={isPending}
                  className="w-full py-4 rounded-xl text-sm font-black text-white mt-2 transition-all hover:brightness-125 hover:shadow-[0_0_20px_rgba(14,165,233,0.4)] active:scale-[0.97] disabled:opacity-50 shadow-lg shadow-sky-600/20"
                  style={{
                    background:
            ...
            >
              ...
              <div className="relative z-10 w-full max-w-sm drop-shadow-[0_35px_60px_rgba(0,0,0,0.6)] transform transition-transform duration-700 hover:scale-110">
                <img
                  src="/i.png"
                  alt="Connect Global Connectivity"
                  className="w-full h-full object-contain"
                />
              </div>
              <div className="relative z-10 text-center mt-12 max-w-xs">
                <h3 className="text-xl font-black text-slate-100 mb-4 tracking-tight uppercase">
                  GLOBAL REACH
                </h3>
                <div className="flex gap-2 justify-center mb-6">
                  {["Secure", "Global", "Fast"].map((tag) => (
                    <span
                      key={tag}
                      className="text-[10px] font-black uppercase tracking-widest text-sky-400 px-3 py-1 rounded-full bg-sky-500/10 border border-sky-500/20"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <p className="text-sm text-slate-400 font-medium leading-relaxed">
                  Join a community where communication is fast, secure, and
